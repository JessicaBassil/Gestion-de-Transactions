...
public class ReportPanelRecus extends JPanel{
    ...
    private JLabel lbl_from, lbl_to, lbl_clients, lbl_modePaie;
    ...
    public ReportPanelRecus(DataMenu data_menu) {
        ...
        str_title = "Rapports Recus";
        border = BorderFactory.createTitledBorder(null, str_title, CENTER, 0);
        
        a_tab_headers = new String[]{"No Recu","Date Recu","Client","Montant Recu", "Mode Paie"};
