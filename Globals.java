...
public class Globals {
    ...
    public static void getFileVilles(){
        Globals.map_villes = MyFunctions.getDataObjects(FileName.Villes);
    }
    ...
    public static HashMap getSerialNbs(){
        try{
            ...
            if(Globals.map_serialNbs!=null){
                ...
                Ville.setNoSerie((int)Globals.map_serialNbs.get(Globals.ParentClass.Ville));
            }
