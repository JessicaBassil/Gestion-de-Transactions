...
public class MyMenuBar extends JMenuBar{
    ...
    public MyMenuBar(DataMenu data_menu, JFrame frame) {
        ...
        mi_villes.addActionListener(new MenuBarListener());
        ...
        mi_quitter.addActionListener(new QuitProgram());
        mi_version.addActionListener(new MenuBarListener());
        
        mi_load.addActionListener(new OutilsListener());
        mi_store.addActionListener(new OutilsListener());
    }
    
    
    
    
    private class OutilsListener implements ActionListener{
        @Override
        public void actionPerformed(ActionEvent event){
            Object obj = event.getSource();
            if(obj.equals(mi_load)){ data_menu.setPanel(new LoadFolderPanel(data_menu));}
            if(obj.equals(mi_store)){ data_menu.setPanel(new StoreFolderPanel(data_menu));}
        }
    }
    ...
    private class MenuBarListener implements ActionListener{
        ...
        public void actionPerformed(ActionEvent event){
            ...
            if(obj.equals(mi_villes)){data_menu.setPanel(new InputPanelVilles(data_menu));}
            ...
            if(obj.equals(mi_version)){ data_menu.setPanel(new VersionPanel(data_menu));}
        }
    }
    ...
    private class QuitProgram implements ActionListener{
        public void actionPerformed(ActionEvent event){
            int quit = JOptionPane.showConfirmDialog(frame,"Are you sure you want to exit this application?","Quit",JOptionPane.YES_NO_OPTION);                             
            if(JOptionPane.YES_OPTION == quit){frame.dispose();}
        }
    }
