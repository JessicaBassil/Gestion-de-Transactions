...
public class ReportPanelClients extends JPanel{
    ...
    private JLabel lbl_from, lbl_to, lbl_clients, lbl_villes, lbl_vente, lbl_recu;
    private JTextField txt_from, txt_to;
    private JComboBox<Client> combo_clients;
    private JComboBox<Ville> combo_villes;
    private JCheckBox box_vente, box_recu;
    ...
    public ReportPanelClients(DataMenu data_menu) {
        ...
        lbl_recu = new JLabel("Recu", SwingConstants.CENTER);
        
        box_vente = new JCheckBox();
        box_recu = new JCheckBox();
        ...
        str_title = "Rapports Clients";
        border = BorderFactory.createTitledBorder(null, str_title, CENTER, 0);
        
        a_tab_headers = new String[]{"No Trs","Description","Date Trs","Client","Montant"};
        ...
        gbc.gridy = 0;
        pan_filter.add(lbl_recu, gbc);
        
        gbc.gridy = 1;
        pan_filter.add(box_recu, gbc);
    ...
    private void RefreshTable(){
        ...
        boolean isVente = false, isRecu = false;
    
        if(box_vente.isSelected()){ isVente = true; }
        if(box_recu.isSelected()) { isRecu = true;}
        
        tableModel.setRowCount(0);
           
        
        
        if(!Globals.map_recus.isEmpty() && isRecu){
            ...
            while(it.hasNext()){
                ...
                Ville pair_ville = pair.getValue().getClient().getVilleCompte();
        ...
        if(!Globals.map_ventes.isEmpty() && isVente){
